        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="flex items-center space-x-6">
              ...
              <Link href="/companion/messages" className="text-pink-600 dark:text-pink-500 font-semibold">
                Messages
              </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Chat with your clients about booking details
          </p>
        </motion.div>
              ...
              {isLoading ? (
                ...
                <div className="px-4 py-8 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    No conversations yet. Messages will appear here once you accept a booking.
                  </p>
                </div>
              ) : (
